# Template Agentic Astro Project

Last updated: 2026-06-22

This file is the living implementation tracker for turning Template into a multi-purpose Astro site with an agent-first runtime. Update it whenever the project adds or changes major architecture, MCP servers, skills, libraries, content models, routes, or implementation priorities.

## FIH Migration Status

Completed on 2026-06-21: `/home/salah/falafelinhotpot/02_web/site` was migrated into this Template Astro 5 base as the public Falafel in Hotpot site.

Locked outcomes:

- Template remains the technical base on Astro 5.
...
- Template demo routes and content were moved to `src/_template-demo/`.
- Demo public image folders were moved out of `public/` and into `src/_template-demo/public/images/`.
...
Primary goal: use Template as the preserved upstream base for a multi-purpose Astro site whose public surface is Falafel in Hotpot and whose internal dashboard/agent surfaces remain available for later phases.
...
- Official Template Astro theme cloned from `https://github.com/erlandv/template`
- MIT license
...
Default rule: preserve Template first. Do not replace the theme with a component framework.

Already available:

- Template Astro components for layout, dashboard, forms, cards, charts, tables, modal, toast
- `astro-icon` with Lucide and Simple Icons
- Tailwind CSS v4 tokens in `src/styles/global.css`
- Chart.js through the existing Template chart component
...
- Tables/search:
  - Keep Template `DataTable` for simple admin tables.
...
- Full shadcn migration. It would fight the Template structure unless the project commits to React islands broadly.
...
- Generate `DESIGN.md` from Template tokens and components.
