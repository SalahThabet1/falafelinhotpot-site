...
author: "Falafel"
image: "../../assets/images/newsletters/cultural/issue-09.jpg"
draft: false
metadata:
...
import Fig1 from '~/assets/images/newsletters/cultural/cultural-09-the-shaming-culture-fig-1.jpg';
import Fig2 from '~/assets/images/newsletters/cultural/cultural-09-the-shaming-culture-fig-2.jpg';
import Fig3 from '~/assets/images/newsletters/cultural/cultural-09-the-shaming-culture-fig-3.jpg';
import Fig4 from '~/assets/images/newsletters/cultural/cultural-09-the-shaming-culture-fig-4.jpg';
...
In Arab culture, what you do does not belong only to you — it belongs to your family, your community. The question <Ar>ما رأي الناس</Ar> — what will people say — is not asking for information. It is delivering a verdict. And it outsources the judgment to an unnamed, faceless collective whose opinion cannot be argued with because they have no specific face.


<EditionFigure src={Fig4} alt="Figure 4" />


<PullQuote>The genius of shame as social control is that it does not need enforcement. Once internalised, it enforces itself. You do not need someone watching you. You watch yourself on their behalf.</PullQuote>
