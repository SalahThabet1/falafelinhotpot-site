...
- **Installation Method**: Updated Quick Start and Getting Started documentation to recommend `npm create astro@latest -- --template erlandv/template` as the primary installation method
...
- **README.md**:
  ...
  - Added "Why Template?" section explaining unique value proposition
...
- Initial release of Template - SaaS Landing Page Theme for Astro 5
